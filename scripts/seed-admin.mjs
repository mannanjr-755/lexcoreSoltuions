...
if (!databaseUrl) {
  console.error("[lexcore] Cannot seed — DATABASE_URL is missing.");
  process.exit(1);
}
...
const staff = [
  { employeeId: "EMP-001", fullName: "Abdul-Mannan", email: "abdul.mannan@lexcore.com", department: "Engineering", position: "Software Engineer", salary: 120000 },
  { employeeId: "EMP-002", fullName: "Raid Zia", email: "raid.zia@lexcore.com", department: "Engineering", position: "Frontend Developer", salary: 110000 },
  { employeeId: "EMP-003", fullName: "Muhammad-Yousuf", email: "muhammad.yousuf@lexcore.com", department: "Operations", position: "Project Coordinator", salary: 100000 },
...
async function main() {
  ...
  if (!(await prisma.systemSettings.findFirst())) {
    await prisma.systemSettings.create({
      data: { companyName: "Lexcore Solutions", theme: "light", currency: "PKR" }
    });
  }
...
main()
  ...
  .catch(async (error) => {
    console.error("[lexcore] Seed error:", error);
